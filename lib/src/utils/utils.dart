...
class ByteConversionUtilities {
  ...
  static double getDouble64(dynamic int8list, [Endian endian = Endian.big]) {
    var bdata = ByteData.view(int8list.buffer);
    return bdata.getFloat64(0, endian);
  }

  /// Get a double from a list of 4 bytes.
  static double getDouble32(dynamic int8list, [Endian endian = Endian.big]) {
    var bdata = ByteData.view(int8list.buffer);
    return bdata.getFloat32(0, endian);
  }

  /// Get an int from a list of 4 bytes.
  static int getInt32(dynamic int8list, [Endian endian = Endian.big]) {
    var bdata = ByteData.view(int8list.buffer);
    return bdata.getInt32(0, endian);
  }

  /// Get an int from a list of 2 bytes.
  static int getInt16(dynamic int8list, [Endian endian = Endian.big]) {
    var bdata = ByteData.view(int8list.buffer);
    return bdata.getInt16(0, endian);
  }

  /// Get an int from a list of 1 byte.
  static int getInt8(dynamic int8list) {
    var bdata = ByteData.view(int8list.buffer);
